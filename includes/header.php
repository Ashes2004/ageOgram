...
<header class="flex items-center justify-between bg-white whitespace-nowrap border-b border-gray-200 px-10 py-3 fixed top-0 z-50 w-screen">
  <!-- Left: Logo + Brand -->
  <div class="flex items-center gap-3 text-[#111418]" onclick="window.location.href = '/AgeOgram/user/dashboard.php';" style="cursor:pointer">
  ...
  <!-- Center: Navigation Links (hidden on dashboard.php) -->
  <?php if ($current_page !== 'dashboard.php'): ?>
  <nav class="flex gap-10 text-sm font-medium text-gray-700">
    <a href="/AgeOgram/user/dashboard.php" class="hover:text-blue-600 transition">Home</a>
    <a href="/AgeOgram/user/posts.php" class="hover:text-blue-600 transition">Posts</a>
    <a href="/AgeOgram/user/explore.php" class="hover:text-blue-600 transition">Explore</a>
    <a href="/AgeOgram/user/messages.php" class="hover:text-blue-600 transition">Messages</a>
    <a href="/AgeOgram/user/friends.php" class="hover:text-blue-600 transition">Friends</a>
  </nav>
  <?php endif; ?>
